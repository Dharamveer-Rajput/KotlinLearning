package com.kotlinlearning.soap_sample
...
import kotlinx.android.synthetic.main.activity_main_soap.*


class MainSoapActivity : AppCompatActivity(), LoaderManager.LoaderCallbacks<List<String>> {

    // Log tag constant.
    private val LOG_TAG = MainSoapActivity::class.java.simpleName
